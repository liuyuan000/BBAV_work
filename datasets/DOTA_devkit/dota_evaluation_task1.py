...
def main():
    ...
    annopath = r'DLR_Dataset/Crop/labelTxt/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'DLR_Dataset/Crop/test.txt'
    # For DOTA-v1.5
    # classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
    ...
    # classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
    #             'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter']
    classnames = ['bus', 'cam', 'Pkw', 'pkw_trail', 'Truck', 'truck_trail', 'van_trail']
    # ap:  0.6537071233211924
    # map: 0.5678790238601716
    # classaps:  [85.87379689 68.92405133 74.78080016 67.98156107 80.50254203 23.63636364
    #  25.         19.02129402 65.37071233] 
    classaps = []
    map = 0
    nums = []
    for classname in classnames:
        print('classname:', classname)
        rec, prec, ap, line_num = voc_eval(detpath,
             annopath,
             imagesetfile,
             classname,
             ovthresh=0.5,
